	...
	template:`<div>
        <div class="our_advantage zixun clearfix" style="padding-bottom: 60px;">
          <div class="advantage_container">
            <div class="our_box index-tab5 mt30" style="font-size: 32px;letter-spacing:15px;padding-top: 80px;">
              请留下您的联系方式，成为我们的城市合伙人吧！
            </div>
            ...
            <div class="advantage_container mt30">
                <Row :gutter="64">
                    <Col span="7">
                        ...
                        <div class="mt20 tl"><img src="guanwangimg/companyewm.png" style="width: 120px;"></div>
                    </Col>
                    <Col span="6">
                    ...
                    <Col span="6">
                        ...
                        <div class="col10 fz-14 mt10"><Icon type="ios-email" class="fz-26 va pr10"></Icon>service@toustone.cn</div>
                        <div class="mt20 tl"><img src="guanwangimg/qrcode2.png" style="width: 100px;"></div>
                    </Col>
                    <Col span="5">
