    ...
    var myScrollTop = parseInt(get_scrollTop_of_body());//获取ScrollTop的值
	    ...
	    $('.navbar-fixed-top').addClass("indexheader2");
	    $('.navbar-fixed-top').removeClass("indexheader1");
	    }else{    
	    $('.navbar-fixed-top').addClass("indexheader1");
	    $('.navbar-fixed-top').removeClass("indexheader2");
		}
  	})
